...
AIR_LLM_REFINER_MODEL = "phi3-mini"                 # model loaded in Air LLM
...
CODER_MODEL_LOCAL = "qwen2.5:7b-instruct-q6_K" # main coder — set to same as refiner for low-end machines
# ── Cloud models ──────────────────────────────────────────────────────────────
